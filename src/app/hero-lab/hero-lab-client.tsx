...
import { HeroAurora } from "@/components/hero-lab/hero-aurora";
import { HeroMagnet } from "@/components/hero-lab/hero-magnet";
import { HeroSpotlight } from "@/components/hero-lab/hero-spotlight";
import { INK, YELLOW } from "@/lib/motion";

const VARIANTS = [
  { id: 0, label: "01 Gulltråder", component: HeroAurora },
  { id: 1, label: "02 Magnetfelt", component: HeroMagnet },
  { id: 2, label: "03 Lommelykt", component: HeroSpotlight },
] as const;
