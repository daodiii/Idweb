...
export const FAQS: FAQ[] = [
  {
    ...
    answer:
      "Prisen avhenger av omfanget og kompleksiteten til prosjektet. En enkel bedriftsnettside starter typisk fra 15 000 kr, mens mer avanserte løsninger med nettbutikk eller spesialfunksjonalitet kan koste fra 30 000 kr og oppover. Jeg gir alltid et fast prisestimat før jeg starter, slik at du vet nøyaktig hva du betaler for. Ta kontakt for et uforpliktende tilbud tilpasset ditt behov.",
  },
  {
    question: "Hvor lang tid tar det å lage en nettside?",
    answer:
      "En standard bedriftsnettside tar vanligvis 3–6 uker fra oppstart til lansering, avhengig av omfanget og hvor raskt jeg får tilbakemeldinger og innhold fra deg. Enklere prosjekter kan leveres raskere, mens større nettbutikker eller skreddersydde løsninger kan ta 6–10 uker. Jeg setter alltid opp en tydelig tidsplan i starten av prosjektet.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Ja, absolutt. Jeg bygger alle nettsider med et brukervennlig administrasjonspanel som lar deg oppdatere tekst, bilder og annet innhold uten teknisk kunnskap. Jeg gir deg også opplæring etter lansering slik at du er trygg på å gjøre endringer selv. Hvis du heller vil at jeg gjør det, er det inkludert i driftsavtalen.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "SEO står for søkemotoroptimalisering og handler om å gjøre nettsiden din synlig i Google når folk søker etter det du tilbyr. Kort sagt: uten SEO finner ikke kundene deg. Alle nettsidene jeg lager har grunnleggende SEO innebygd (rask lastetid, riktig struktur, metatagger). For de som ønsker å rangere enda høyere, tilbyr jeg også løpende SEO-tjenester med søkeordanalyse, innholdsproduksjon og lenkebygging.",
  },
  {
    question: "Hvilken teknologi bruker du?",
    answer:
      "Jeg velger teknologi basert på hva som passer best for prosjektet ditt. For de fleste bedriftssider bruker jeg moderne rammeverk som gir rask lastetid, god sikkerhet og enkel administrasjon. For nettbutikker bruker jeg velprøvde plattformer med integrasjon mot norske betalingsløsninger som Vipps og Klarna. Jeg gir deg alltid en anbefaling basert på dine behov og budsjett.",
  },
  {
    question: "Hva inkluderes i prisen?",
    answer:
      "Alle mine priser inkluderer design, utvikling, mobiloptimalisering, grunnleggende SEO, kontaktskjema, SSL-sertifikat og opplæring i administrasjonspanelet. Hosting og domenenavn kan inkluderes i driftsavtalen eller håndteres separat. Jeg er alltid tydelig på hva som er inkludert og hva som eventuelt kommer i tillegg — ingen overraskelser.",
  },
  {
    question: "Tilbyr du hosting?",
    answer:
      "Ja. Jeg tilbyr rask og sikker hosting på norske servere med daglige sikkerhetskopier og 99,9 % oppetidsgaranti. Hosting kan bestilles som en del av driftsavtalen eller som en separat tjeneste. Jeg håndterer alt det tekniske slik at du slipper å forholde deg til serveradministrasjon.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Jeg opererer vanligvis med en tredeling: 30 % ved oppstart, 40 % ved godkjent design, og 30 % ved lansering. For større prosjekter kan jeg tilpasse betalingsplanen. Driftsavtaler faktureres månedlig eller årlig etter ønske. Jeg sender alltid en detaljert faktura med oversikt over hva du betaler for.",
  },
];
