...
export const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Nei, vi har ingen bindingstid på noen av tjenestene mine. Vi tror på å beholde kunder gjennom kvalitet, ikke kontrakter. Du kan når som helst si opp driftsavtalen med én måneds varsel. Nettsiden er din — du eier alt innhold, design og kode.",
  },
  {
