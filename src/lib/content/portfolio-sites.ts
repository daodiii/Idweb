...
export const PORTFOLIO_SITES: PortfolioSite[] = [
  {
    ...
    images: {
      ...
      collage: [
        ...
        { src: "/images/portfolio/brobekk-collage-5.webp", alt: "Brobekk Legekontor — desktop visning", position: "bottom-right", aspectRatio: "desktop" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    images: {
      ...
      collage: [
        { src: "/images/portfolio/iqra-collage-4.webp", alt: "Iqra Senter — desktop fullside", position: "center", aspectRatio: "desktop" },
        { src: "/images/portfolio/iqra-collage-2.webp", alt: "Iqra Senter — tablet visning", position: "top-left", aspectRatio: "tablet" },
        { src: "/images/portfolio/iqra-collage-3.webp", alt: "Iqra Senter — tablet visning alternativ", position: "top-right", aspectRatio: "tablet" },
        { src: "/images/portfolio/iqra-collage-1.webp", alt: "Iqra Senter — desktop bred visning", position: "bottom-left", aspectRatio: "desktop" },
        { src: "/images/portfolio/iqra-collage-5.webp", alt: "Iqra Senter — tablet oversikt", position: "bottom-right", aspectRatio: "tablet" },
      ],
    },
  },
  {
