/**
 * Catchphrases, CTAs, and slogans for use across the website.
 * Organized by use case for easy reference when implementing design.
 */
...
export const HERO_SUBHEADLINES = [
  "Skreddersydde nettsider designet for å konvertere besøkende til betalende kunder.",
  "Profesjonell nettside, synlighet i Google, og flere henvendelser. Alt fra én utvikler.",
  "Moderne, raske nettsider bygget for norske bedrifter som vil vokse.",
  "Slutt å tape kunder til konkurrenter med bedre nettsider.",
] as const;
...
export const TRUST_BADGES = [
  "Spesialist i Next.js og React",
  "6+ prosjekter levert",
  "90+ PageSpeed-score på alle prosjekter",
  "5.0 stjerner på Google",
  "Ingen bindingstid",
  "Rask responstid på support",
] as const;
