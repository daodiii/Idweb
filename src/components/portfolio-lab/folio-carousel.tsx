...
/**
 * Portfolio 04 — «Karusellen». A true 3D ring of site cards. Drag to
 * spin with momentum; the ring idles in a slow rotation. The card
 * facing front is lifted into focus, the rest angle back into depth.
 */
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-1 font-mono text-xs" style={{ color: "rgba(243,240,231,0.5)" }}>
              {focusedSite.domain}
              {focusedStat ? ` — ${focusedStat.result}` : ""}
            </p>
          </div>
