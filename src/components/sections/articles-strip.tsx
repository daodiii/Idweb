          ...
          >
            <span className="block overflow-hidden">
              <motion.span
                ...
                className="block text-[clamp(1.8rem,4.5vw,3.6rem)] font-black leading-[0.95] tracking-[-0.02em]"
              >
          ...
          {POSTS.map((post, i) => (
            ...
            >
              ...
              >
                ...
                <div>
                  <h3 className="font-serif text-xl font-extrabold leading-snug tracking-tight sm:text-2xl">
                    {post.title}
                  </h3>
