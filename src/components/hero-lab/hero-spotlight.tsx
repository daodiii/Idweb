...
/**
 * Hero 03 — «Lommelykt». Two parallel worlds occupy the same space:
 * the dark page, and a vivid yellow world hiding beneath it. The
 * cursor is a flashlight — a circular lens that reveals the yellow
 * world wherever it moves. Without a pointer the lens drifts on its
 * own orbit.
 */
